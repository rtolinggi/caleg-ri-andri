...
namespace App\Filament\Resources\PemungutanSuaraResource\RelationManagers;
...
class DaftarPemilihsRelationManager extends RelationManager
{
    ...
    protected static ?string $modelLabel = 'Daftar Pemilih Tetap';

    protected static ?string $pluralModelLabel = 'Daftar Pemilih Tetap';
